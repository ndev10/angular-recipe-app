...
import {BootstrapDropdownDirective} from './shared/bootstrap-dropdown.directive';
...
@NgModule({
  ...
  providers: [ShoppingListService,RecipeService,DataStrorageService,AutheService,AuthGuard],
